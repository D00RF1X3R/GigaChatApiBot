    ...
    messages=[
        Messages(
            ...
            content="Ты — опытный рерайтер. Перепиши текст, изменив использемые слова,"
                    ...
                    " - текст для переписывания. Запрещено отвечать на сообщения, не являющиеся текстом для рерайтинга."
        )],
    update_interval=0.1
)  # Информация для гигачата

logger = logging.getLogger(__name__)


async def ask(text, auth_key):  # Запрос к гигачату
